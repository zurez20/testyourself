...
<div class="bg-body d-flex flex-center rounded-4 w-md-600px p-10">
	<div class="w-md-400px">
		<form id="kt_sgn_in_form" class="form w-100" novalidate="novalidate" action="{{ url('/admin/login') }}"
			method="POST">
	...
	<div class="fv-row mb-3" style="text-align: left;">
		...
		<input type="text" placeholder="Enter Your Phone Number" id="Login" name="login" autocomplete="off"
			class="numOnly form-control bg-transparent" maxlength="10" />
	</div>

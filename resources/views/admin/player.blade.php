...
@section('breadcrumb')
    <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Player</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
        ...
        <li class="breadcrumb-item text-dark">Player</li>
    </ul>
@endsection
@section('content')
        ...
        <div class="card">
            <div class="card-body p-0">
                ...
                <div class="card-px text-center py-20 ">
                    <p class="text-gray-400 fs-4 fw-semibold mb-10">Looks like you do not have any players added here.
                        <br />If you want to add a player, click on the button below.
                    </p>
                    </p>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="data_table">
                    <thead>
                        <tr class="text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="text-center min-w-50px">Email</th>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                <div class="modal-header">
                    <h1 class="modal-tital w-100 text-center"> Add Player </h1>
                ...
                <form autocomplete="off" action="{{ url('admin/player/add') }}" enctype="multipart/form-data"
                    method="POST" id="addForm">
                    <div class="modal-body scroll-y px-10 px-lg-15 pt-0">
                        @csrf
                        <div class="row g-5 mt-2">
                            <div class="col-md-6 fv-row g-5 mt-5">
                                <label class="required fs-6 fw-semibold mb-2">Player Name</label>
                                <input type="text" class="form-control txtOnly space" placeholder="Enter Name" id="name" name="name">
                            </div>
    ...
    <div class="modal fade updateclearonclose" id="updateModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                <div class="modal-header">
                    <h1 class="modal-tital w-100 text-center"> Update Player </h1>
                    <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                        <span class="svg-icon svg-icon-1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <form autocomplete="off" action="{{ url('admin/player/update') }}" enctype="multipart/form-data"
                    method="post" id="updateForm">
                    <div class="modal-body scroll-y px-10 px-lg-15 pt-0">
                        @csrf
                        <input type="hidden" name="playerId" id="updatePlayerId">
                        <div class="row g-5 mt-5">
                            <div class="col-md-6 fv-row">
                                <label class="required fs-6 fw-semibold mb-2">Player</label>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/player/delete') }}" id="deleteForm" method="post">
                    @csrf
                    <input type="hidden" id="playerId" name="playerId">
                    <div class="modal-body">
                        <span>Are you sure you want to delete this player ? <br> Action cannot be reverted</span>
                    </div>
                    <div class="modal-footer">
...
@section('scripts')
    ...
    <script>
        ...
        function openUpdateModal(playerId) {
            let player = players.find(x => x.id == playerId);
            $('#updatePlayerId').val(player.id);
            $('#updatename').val(player.name);
            $('#updatedescription').val(player.desc);
            $('#updatestatus').html('');
            $('#updatestatus').append('<option value="1" ' + (player.status == 1 ? 'selected' : '') + '>Active</option>');
            $('#updatestatus').append('<option value="0" ' + (player.status == 0 ? 'selected' : '') +
                '>Inactive</option>');

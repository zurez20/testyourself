...
@section('breadcrumb')
<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Add Address of {{$customer->fname}} {{$customer->lname}}</h1>
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
    ...
    <li class="breadcrumb-item text-dark">Add Address</li>
</ul>
@endsection

@section('content')
<form autocomplete="off" action="{{ url('admin/customer/customeraddress/add') }}" enctype="multipart/form-data" method="post" id="addForm" onsubmit="return checkValidation();">
    @csrf
                ...
                <div class="col-md-8 fv-row">
                    <div class="row g-5 mb-5">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Address Line 1" id="address1" name="address1" validate>
                        </div>

                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Address Line 2</label>
                            <input type="text" class="form-control" placeholder="Enter Address Line 2" id="address2" name="address2">
                        </div>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <input type="text" class="form-control" placeholder="Enter City" id="city" name="city" validate>
                        </div>

                        <div class="col-md-4 fv-row">
                            <label class="fs-6 required fw-semibold mb-2">Pincode</label>
                            <input type="text" class="form-control" placeholder="Enter Pincode" id="pincode" name="pincode" maxlength="6" validate>
                        </div>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <input type="text" class="form-control numOnly" placeholder="Enter Phone" id="phonee" name="phonee" maxlength="10" value="{{ $customer->phone}}" data-validation="phoneNo" data-title="Phone No" validate>
                        </div>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Latitude" id="lat" name="lat" readonly validate>
                        </div>

                        <div class="col-md-4 fv-row">
                            <label class="fs-6 required fw-semibold mb-2">Longitude</label>
                            <input type="text" class="form-control" placeholder="Enter Longitude" id="long" name="long" readonly validate>
                        </div>
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <textarea class="form-control" placeholder="Enter Google Address" id="googleAddress" name="googleAddress" rows="3" validate></textarea>
                        </div>

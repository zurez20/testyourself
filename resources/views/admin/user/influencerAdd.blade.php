...
@endsection
@section('breadcrumb')
<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Add Influencer Information</h1>
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
    ...
    <li class="breadcrumb-item text-dark">Add Influencer</li>
</ul>
@endsection
@section('content')
<form autocomplete="off" action="{{ url('admin/influencer/add') }}" enctype="multipart/form-data" method="post" id="addForm">
    @csrf
                        ...
                        <div class="card-body">
                            <div class="row g-5 mb-5">
                                <div class="col-md-6 fv-row ">
                                    ...
                                    <input type="text" class="form-control txtOnly space" placeholder="Enter First Name" id="fname" name="fname" minlength="1" required>
                                </div>
                                <div class="col-md-6 fv-row ">
                                    <label class="required fs-6 fw-semibold mb-2">Last Name</label>
                                    <input type="text" class="form-control txtOnly space" placeholder="Enter Last Name" id="lname" name="lname" minlength="1" required>
                                </div>

                                <div class="col-md-4 fv-row">
                                    <label class="required fs-6 fw-semibold mb-2">Phone</label>
                                    <input type="text" class="form-control numOnly" placeholder="Enter Phone" id="phone" name="phone" maxlength="10" onkeyup="checkphone('influencerPhone')" data-validation="phoneNo" data-title="Phone No" required>
                                    <span class="text-danger" id="phonetitle"></span>
                                </div>

                                <div class="col-md-4 fv-row">
                                    <label class="required fs-6 fw-semibold mb-2">Email</label>
                                    <input type="text" class="form-control space" placeholder="Enter Email" id="email" name="email" onkeyup="checkemail('influencerEmail')" data-validation="email" data-title="Email" required>
                                ...
                                <!-- Password Field -->
                                 @if($influencerRole->panelFlag == 1)
                                <div class="col-md-5 fv-row">
                                    <label class="required fs-6 fw-semibold mb-2">Password</label>
                                    <input type="password" class="form-control space" onkeyup="validatePass()" rows="3" id="Password" name="password" placeholder="Enter Password" data-validation="password" data-title="Password" {{$influencerRole->panelFlag == 1 ? 'required': ''}}><br>
                                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row g-5 mb-5">
                                <div class="col-md-6 fv-row">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Influencer Tag" id="influencerTag" name="influencerTag">
                                </div>

                                <div class="col-md-6 fv-row">
                                    <label class="fs-6 fw-semibold mb-2">Influencer Facebook Link</label>
                                    <input type="text" class="form-control" placeholder="Enter Facebook Link" id="influencerFbLink" name="influencerFbLink" data-validation="fb" data-title="Facebook Link" validate>
                                </div>

                                <div class="col-md-4 fv-row">
                                    <label class="fs-6 fw-semibold mb-2">Influencer Instagram Link</label>
                                    <input type="text" class="form-control" placeholder="Enter Instagram Link" id="influencerInstaLink" name="influencerInstaLink" data-validation="insta" data-title="Instagram Link" validate>
                                </div>

                                <div class="col-md-4 fv-row ">
                                    <label class="fs-6 fw-semibold mb-2">Influencer YouTube Link</label>
                                    <input type="text" class="form-control" placeholder="Enter YouTube Link" id="influencerYoutubeLink" name="influencerYoutubeLink" data-validation="youtube" data-title="You Tube Link" validate>
                                </div>

                                <div class="col-md-4 fv-row">
                                    <label class="fs-6 fw-semibold mb-2">Influencer Website Link</label>
                                    <input type="text" class="form-control" placeholder="Enter Website Link" id="influencerWebsiteLink" name="influencerWebsiteLink" data-validation="website" data-title="Website Link" validate>
                                </div>

                                <div class="col-md-3 fv-row">
                                    <label class="fs-6 fw-semibold mb-2">Feature 1</label>
                                    <input type="text" class="form-control" placeholder="Enter Feature 1" id="influencerFeature1" name="influencerFeature1">
                                </div>

                                <div class="col-md-3 fv-row">
                                    <label class="fs-6 fw-semibold mb-2">Feature 2</label>
                                    <input type="text" class="form-control" placeholder="Enter Feature 2" id="influencerFeature2" name="influencerFeature2">
                                </div>

                                <div class="col-md-3 fv-row">
                                    <label class="fs-6 fw-semibold mb-2">Feature 3</label>
                                    <input type="text" class="form-control" placeholder="Enter Feature 3" id="influencerFeature3" name="influencerFeature3">
                                </div>
                                <div class="col-md-3 fv-row">
                                    <label class="fs-6 fw-semibold mb-2">Feature 4</label>
                                    <input type="text" class="form-control" placeholder="Enter Feature 4" id="influencerFeature4" name="influencerFeature4">
                                </div>

                                <div class="col-md-6 fv-row">
                                    <label class="fs-6 fw-semibold mb-2">Influencer Bio</label>
                                    <textarea class="form-control" placeholder="Enter Influencer Bio" id="influencerBio" name="influencerBio" rows="4"></textarea>
                                </div>
                                <div class="col-md-6 fv-row">
                                    <label class="fs-6 fw-semibold mb-2">Short Description</label>
                                    <textarea class="form-control" placeholder="Enter Short Description" id="shortdesc" name="shortdesc" rows="4"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3 mb-3">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="number" class="preventMinus form-control space" placeholder="Enter Sequence" name="sequences[]" min="0" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3 mb-3">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" class="form-control space" placeholder="Video Link" name="links[]" required>
                                        </div>
                                        <div class="col-md-12 fv-row">
                                            <label class="required fs-6 fw-semibold mb-2">Sequence</label>
                                            <input type="number" class="preventMinus form-control space" placeholder="Enter Sequence" name="videosequences[]" min="0" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    function addMediaCard(type) {
        ...
        var totalMediaCards = container.getElementsByClassName('image-card').length + container.getElementsByClassName('video-card').length;

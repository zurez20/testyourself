...
@section('breadcrumb')
    <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Age Range</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
        ...
        <li class="breadcrumb-item text-dark">Age Range</li>
    </ul>
@endsection
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                <div class="modal-header">
                    <h1 class="modal-tital w-100 text-center"> Add Age Range </h1>
                    ...
                    <div class="modal-body scroll-y px-10 px-lg-15 pt-0">
                        ...
                        <div class="row g-5 mt-2">
                            ...
                            <div class="col-md-6 fv-row g-5 mt-5">
                                <label class="required fs-6 fw-semibold mb-2">Age Range Name</label>
                                <input type="text" class="form-control space" placeholder="Enter Name"
                                    id="name" name="name">
                            </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Delete Age Range</h5>
                    <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                        <span class="svg-icon svg-icon-1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">

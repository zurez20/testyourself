! function(t, e) {
  ...
  return function(t) {
      ...
      3: function(t, e, n) {
          ...
          var M = T("A"),
              O = T("BODY"),
              j = m.isMSIE && m.browserVersion < 11 ? "&nbsp;" : "<br>";
          ...
          var pt = {
              ...
              walkPoint: function(t, e, n, o) {
                  for (var i = t; i && (n(i), !st(i, e));) i = rt(i, o && t.node !== i.node && e.node !== i.node)
              },
              ancestor: V,
          ...
          function bt(t, e) {
              ...
              for (n = 0; n < a.length; n++)
                  ...
                  l.nodeValue, e && l.nextSibling && pt.isText(l.nextSibling) && u === l.nodeValue.length && (u -= l.nodeValue.length, l = l.nextSibling), i = l, n = u
              }
              return {
                  cont: i,
                  offset: n
                                  ...
                                  if ("undefined" == typeof Symbol || null == t[Symbol.iterator]) {
                                      if (Array.isArray(t) || (t = function(t, e) {
                                              if (t) {
                                                  ...
                                                  return "Object" === n && t.constructor && (n = t.constructor.name), "Map" === n || "Set" === n ? Array.from(n) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? jt(t, e) : void 0
                                              }
                                          }(t))) {
                                          var e = 0,
                                              n = function() {};
          ...
          var Xt = /^([A-Za-z][A-Za-z0-9+-.]*\:[\/]{2}|tel:|mailto:[A-Z0-9._%+-]+@)?(www\.)?(.+)$/i,
              Qt = function() {
                  function t(e) {
                      var n = this;
                      ! function(t, e) {
              ...
              return e = t, (n = [{
                  ...
                  value: function() {
                      var t = this.options.dialogsInBody ? this.$body : this.options.container,
                          ...
                          n = '<input type="button" href="#" class="'.concat("btn btn-primary note-btn note-btn-primary  note-link-btn", '"onclick="inserted()" value="').concat(this.lang.link.insert, '" disabled>');
              ...
              return e = t, (n = [{
                  ...
                  value: function() {
                      ...
                      var o = this.options.dialogsInBody ? this.$body : this.options.container,
                          i = ['<div class="form-group note-form-group note-group-select-from-files">', '<label for="note-dialog-image-file-' + this.options.id + '" class="note-form-label">' + this.lang.image.selectFromFiles + "</label>", '<input id="note-dialog-image-file-' + this.options.id + '" class="note-image-input form-control-file note-form-control note-input" ', ' type="file" onchange="inserted()" name="files" accept="image/*" multiple="multiple"/>', t, "</div>", '<span> OR </span>', '<div class="form-group note-group-image-url">', '<label for="note-dialog-image-url-' + this.options.id + '" class="note-form-label">' + this.lang.image.url + "</label>", '<input id="note-dialog-image-url-' + this.options.id + '" class="note-image-url form-control note-form-control note-input" type="text"/>', "</div>"].join(""),
                          r = '<input type="button" href="#" class="'.concat("btn btn-primary note-btn note-btn-primary note-image-btn", '"onclick="inserted()" value="').concat(this.lang.image.insert, '" enable>');
                      this.$dialog = this.ui.dialog({
      ...
      52: function(t, e, n) {
          ...
          var s = r.a.create('<div class="note-editor note-frame panel panel-default"/>'),
              ...
              y = r.a.create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" id="linkModal" role="dialog"/>', function(t, e) {
                  e.fade && t.addClass("fade"), t.attr({
                      "aria-label": e.title
                  }), t.html(['<div class="modal-dialog">', '<div class="modal-content">', e.title ? '<div class="modal-header"><div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal"><span class="svg-icon svg-icon-1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="currentColor" /><rect x="7.41422" y="6" width="16" height="2" rx="1" transform="rotate(45 7.41422 6)" fill="currentColor" /></svg></span></div><h4 class="modal-title">' + e.title + "</h4></div>" : "", '<div class="modal-body">' + e.body + "</div>", e.footer ? '<div class="modal-footer">' + e.footer + "</div>" : "", "</div>", "</div>"].join(""))
              }),
          ...
          n(3), n(4), i.a.summernote = i.a.extend(i.a.summernote, {
